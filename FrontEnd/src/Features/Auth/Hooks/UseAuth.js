...
import { register, login, getMe, logout, uploadSplit } from "../Auth.services"
...
return {user,loading,registerHandler,loginHandler,getMeHandler,logOutHandler,uploadSplitHandler}
}
