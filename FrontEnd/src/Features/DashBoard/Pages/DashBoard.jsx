...
const DashBoard = () => {
    ...
    return (
        dashLoad ? <Loading /> :
            (
                previousSession ? <div className="bg-card border border-border rounded-3xl p-6 shadow-lg">
                ...
                </div> : <div className="flex items-center justify-center py-16">
                    <div className="bg-card border border-border rounded-3xl p-10 text-center max-w-md w-full shadow-lg">
                        ...
                        <p className="mt-3 text-text-secondary">
                            Your workout history is empty. Start your first session and begin tracking your progress!
                        </p>

                        <button onClick={()=>{
                            navigate('/session')
                        }} className="mt-6 bg-primary text-black font-semibold px-6 py-3 rounded-xl hover:opacity-90 transition">
