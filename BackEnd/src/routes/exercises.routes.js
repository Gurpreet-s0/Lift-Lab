...
const { exerciseController,uploadSplitController, getSplitController, updateSplitController, getTodaySplitController, getExerciseController } = require("../controllers/exercise.controller")
...
exerciseRouter.get("/getExercises",getExerciseController)
